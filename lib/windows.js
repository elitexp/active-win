...
var lpctstr = {
    ...
    get: function(buffer, offset) {
        ...
        return ref.reinterpretUntilZeros(_buf, 2).toString('ucs2');
    },
...
var trackerLibraryFilename=__dirname +"/" + process.arch + "/ActiveBrowser.dll";
var trackerLibrary=new ffi.Library(trackerLibraryFilename,{
...
function windows() {
	...
	var url=trackerLibrary.GetActiveBrowserUrl();
